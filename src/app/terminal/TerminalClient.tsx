        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="max-w-xl mx-auto relative">
            <input
              ...
              className="w-full py-4 px-6 rounded-full bg-white text-gray-900 shadow-lg focus:outline-none focus:ring-4 focus:ring-gray-500 text-lg placeholder-gray-400"
            />
